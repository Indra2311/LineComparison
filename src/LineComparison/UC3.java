...
public class UC3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Line 1: Enter the cordinates of 1st point");
		int x1 = sc.nextInt();
		int y1 = sc.nextInt();
		
		System.out.println("Line 1: Enter the cordinates of 2nd point");
		int x2 = sc.nextInt();
		int y2 = sc.nextInt();
		
		System.out.println("Line 2: Enter the cordinates of 1st point");
		int x3 = sc.nextInt();
		int y3 = sc.nextInt();
		
		System.out.println("Line 2: Enter the cordinates of 2nd point");
		int x4 = sc.nextInt();
		int y4 = sc.nextInt();
